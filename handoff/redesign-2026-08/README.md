...
> ✅ **정본 반영 완료(2026-08):** `DESIGN.md`에 D-2 차트 강조 예외 추가 · `COMPONENTS.md`에 R-1(홈 세그먼트 폐기)·C-1(GradeButtons `review`)·D-2·D-1·신규 컴포넌트(`hero-card`·`도장`·`ChapterRow`·`ReviewTopCard`·`ScoreDistribution` 등)·T-1/T-2 편차·명명 매핑·**정책 O-1~O-6 결정** 반영 완료.
